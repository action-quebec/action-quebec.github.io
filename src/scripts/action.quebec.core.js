...
({ // ===>>> calendrier action.quebec 
	...
	prec: null,
	suiv: null,
	type: localStorage.getItem('eventType') ?? 'tous',
	...
	loadGoogleCalendar: async function() {
		this.calendar.addEvents(await this.getFilteredEvents());
	},


	filterEvents: async function(type) {
	...
	getFilteredEvents: async function() {
	...
	logEvent: async function(event, type) {
